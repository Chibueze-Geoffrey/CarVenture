...
namespace EzeCarVentures.Migrations
{
    ...
    [Migration("20250201160655_dataAddedNow")]
    partial class dataAddedNow
    {
            ...
            modelBuilder.Entity("EzeCarVentures.Models.Brand", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            BrandId = 1,
                            Accessed = new DateTime(2025, 2, 1, 17, 6, 54, 897, DateTimeKind.Local).AddTicks(8496),
                        ...
                        {
                            BrandId = 2,
                            Accessed = new DateTime(2025, 2, 1, 17, 6, 54, 897, DateTimeKind.Local).AddTicks(8537),
                            BrandName = "BMW",
                            Description = "Class"
                        },
                        new
                        {
                            BrandId = 3,
                            Accessed = new DateTime(2025, 2, 1, 17, 6, 54, 897, DateTimeKind.Local).AddTicks(8550),
                            BrandName = "Mercedes",
                            Description = "Exotic"
                        });
                });
